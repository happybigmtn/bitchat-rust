...
use crate::protocol::efficient_history::{BloomFilter, CompactGameHistory};
use crate::protocol::{GameId, Hash256, PeerId};

use super::diff_engine::BinaryDiffEngine;
use super::merkle::{MerkleNode, StateMerkleTree};
...
impl EfficientStateSync {
    ...
    fn handle_sync_response(
        ...
        let differences = self
            .merkle_tree
            .find_differences(remote_root_hash, self.config.max_merkle_depth);
    ...
    fn handle_merkle_request(
        ...
        Ok(Some(SyncMessage::MerkleResponse { session_id, nodes }))
    }

    /// Handle merkle tree node response
    fn handle_merkle_response(
        &mut self,
        session_id: u64,
        _nodes: Vec<(Vec<usize>, MerkleNode)>,
    ) -> Result<Option<SyncMessage>> {
    ...
    fn handle_state_request(
        ...
        Ok(Some(SyncMessage::StateResponse { session_id, states }))
    }
    ...
    fn handle_diff_update(
        ...
        _session_id: u64,
        _game_id: GameId,
        _diff: super::diff_engine::BinaryDiff,
        _base_hash: Hash256,
    ) -> Result<Option<SyncMessage>> {
